...
export const strings = {
  ...
  adminCardTraining: { ar: 'سجل تدريب الموظفين', en: 'Training register' },
  adminCardTrainingDesc: {
    ar: 'إثبات إنجاز تدريبات حماية البيانات للموظفين، مع تتبع الانتهاء.',
    en: 'Evidence of staff PDPL training completion, with expiry tracking.',
  },
  trainingTitle: { ar: 'سجل تدريب الموظفين', en: 'DPO training register' },
  trainingLead: {
    ar: 'سجلّ موثَّق بتدريبات حماية البيانات لكل موظف يعالج بيانات شخصية.',
    en: 'Auditable record of PDPL training per staff member handling personal data.',
  },
  trainingSubjectName: { ar: 'اسم الموظف', en: 'Subject name' },
  trainingSubjectEmail: {
    ar: 'بريد الموظف الإلكتروني',
    en: 'Subject email',
  },
  trainingTopic: { ar: 'موضوع التدريب', en: 'Training topic' },
  trainingProvider: { ar: 'الجهة المُقدِّمة', en: 'Provider' },
  trainingCompletedAt: { ar: 'تاريخ الإنجاز', en: 'Completed at' },
  trainingValidUntil: { ar: 'صالح حتى', en: 'Valid until' },
  trainingEvidenceRef: { ar: 'مرجع الإثبات', en: 'Evidence ref' },
  trainingNotes: { ar: 'ملاحظات', en: 'Notes' },
  trainingAddRecord: { ar: 'إضافة سجل', en: 'Add record' },
  trainingFilterAll: { ar: 'الكل', en: 'All' },
  trainingFilterActive: { ar: 'سارية', en: 'Active' },
  trainingFilterExpiring: { ar: 'قاربت على الانتهاء', en: 'Expiring' },
  trainingFilterExpired: { ar: 'منتهية', en: 'Expired' },
  trainingFilterNoExpiry: { ar: 'بدون انتهاء', en: 'No expiry' },
  trainingStatusActive: { ar: 'سارية', en: 'Active' },
  trainingStatusExpiring: { ar: 'قاربت على الانتهاء', en: 'Expiring' },
  trainingStatusExpired: { ar: 'منتهية', en: 'Expired' },
  trainingStatusNoExpiry: { ar: 'بدون انتهاء', en: 'No expiry' },
  trainingDaysLeft: { ar: 'يومًا متبقياً', en: 'days left' },
  trainingDaysExpired: { ar: 'يومًا منذ الانتهاء', en: 'days expired' },
  trainingTotalLabel: { ar: 'الإجمالي', en: 'Total' },
  trainingNoRecords: {
    ar: 'لا توجد سجلات تدريب بعد.',
    en: 'No training records yet.',
  },
  trainingDelete: { ar: 'حذف', en: 'Delete' },
  trainingEdit: { ar: 'تعديل', en: 'Edit' },
  trainingSave: { ar: 'حفظ', en: 'Save' },
  trainingCancel: { ar: 'إلغاء', en: 'Cancel' },
  trainingConfirmDelete: {
